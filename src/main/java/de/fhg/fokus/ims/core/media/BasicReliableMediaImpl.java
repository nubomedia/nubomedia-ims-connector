...
public class BasicReliableMediaImpl extends MediaImpl implements BasicReliableMedia 
{
	...
	private Logger logger = LoggerFactory.getLogger(BasicReliableMediaImpl.class);
	...
	{
		super(session);
		logger.debug("BasicReliableMedia initialized.");
	}
	...
	protected void onPrepare() throws MediaPreparationException {
		logger.debug("Preparing basic reliable media.");
