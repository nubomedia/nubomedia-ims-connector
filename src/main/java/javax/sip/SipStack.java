...
public interface SipStack {
	...
	public ListeningPoint createListeningPoint(int port, String transport, int remotePort,
		    String remoteAddr, boolean isServer) throws TransportNotSupportedException, InvalidArgumentException;
    ...
    public ListeningPoint createListeningPoint(String address, int port, String transport,
		    int remotePort, String remoteAddr, boolean isServer) throws TransportNotSupportedException, InvalidArgumentException;
