...
public interface SipProvider {
     ...
     * by the application to create the new client transaction before it sends
    ...
    /**
     * Create a new transaction for request, setting the next hop as the provided remote IP address and port.
     * Used for peer to peer sip communication.
     *  
     ...
     * @throws TransactionUnavailableException
     */
    public ClientTransaction getNewClientTransaction(Request currentRequest, String remoteUserIP, int toPort) 
	throws TransactionUnavailableException;

	public ClientTransaction getNewClientTransaction(Request currentRequest, String remoteUserIP, int toPort, String proto) 
	throws TransactionUnavailableException;
