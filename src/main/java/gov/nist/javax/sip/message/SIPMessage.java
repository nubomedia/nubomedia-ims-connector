...
public abstract class SIPMessage extends MessageObject implements javax.sip.message.Message,
    ...
    public String encode() {
        ...
        Iterator iter = this.unrecognizedHeaders.iterator();
        while (iter.hasNext()) {
			String unrecognized = (String) iter.next();
    ...
    public String getTransactionId() {
        ...
        if (topVia != null
            ...
            String retval2 = Utils.replace(retval.toString().toLowerCase(), ":", "-");
            String retval3 = Utils.replace(retval2, "@", "-");
//            return retval.toString().toLowerCase().replace(":", "-").replace("@", "-") + Utils.getSignature();
            return retval3 + Utils.getSignature();
        }
    }
    ...
    private SIPHeader getSIPHeaderListLowerCase(String lowerCaseHeaderName) {
        return (SIPHeader)nameTable.get(lowerCaseHeaderName);
    }
