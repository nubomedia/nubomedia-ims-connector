...
public class SIPDialog implements javax.sip.Dialog, DialogExt {
    ...
    private void sendAck(Request request, boolean throwIOExceptionAsSipException)
            throws SipException {
        sendAck(request,throwIOExceptionAsSipException,null,0);
    }

    private void sendAck(Request request, boolean throwIOExceptionAsSipException,String remoteIP,int remotePort)
            throws SipException {
        ...
        if(remoteIP!=null && (remoteIP.startsWith("sip:") || remoteIP.startsWith("SIP:")))
        {
           remoteIP=SIPUtils.getWithoutSipPrefix(remoteIP);
           String transport=hop.getTransport();
           hop=new HopImpl(remoteIP,remotePort,transport);
        }
	...
	public void sendAck(Request ackRequest, String remoteIP, int remotePort) throws SipException
    {
      this.sendAck(ackRequest, true, remoteIP, remotePort);
    }
    ...
    public Request createAck(long cseqno) throws InvalidArgumentException, SipException {
        ...
        System.err.println("createAck " + this + " cseqno " + cseqno);
        ...
        if (lastInviteOkReceived < cseqno) {
            ...
            System.out.println("LAST RESPONSE = " + this.lastResponse);
        ...
        try {
          ...
          /*  SipURI uri4transport = null;
            ...
            //Modified by Thomas Pietsch - same branchid for invite and ack
