...
public class SipStackImpl extends SIPTransactionStack implements javax.sip.SipStack, SipStackExt {
     ...
     * Max datagram size.
     */
    public static final String MAX_DATAGRAM_SIZE = "8192";//8 * 1024;
    ...
    public SipStackImpl(Properties configurationProperties) throws PeerUnavailableException {
        ...
        boolean congetstionControlEnabled = Boolean.getBoolean(configurationProperties
                .getProperty("gov.nist.javax.sip.CONGESTION_CONTROL_ENABLED", "true"));
        super.stackDoesCongestionControl = congetstionControlEnabled;

        super.isBackToBackUserAgent = Boolean.getBoolean(configurationProperties.getProperty(
                "gov.nist.javax.sip.IS_BACK_TO_BACK_USER_AGENT", "false"));
        super.checkBranchId = Boolean.getBoolean(configurationProperties.getProperty(
                "gov.nist.javax.sip.REJECT_STRAY_RESPONSES", "false"));
    }
    ...
    public ListeningPoint createListeningPoint(int port, String transport)
	 ...
	 public ListeningPoint createListeningPoint(int port, String transport, int remotePort, String remoteAddr, boolean isServer)
            throws TransportNotSupportedException, InvalidArgumentException
    {
      if (super.stackAddress == null)
            throw new NullPointerException("Stack does not have a default IP Address!");
      return this.createListeningPoint(super.stackAddress, port, transport, remotePort, remoteAddr, isServer);
    }
     ...
     * @see javax.sip.SipStack#createListeningPoint(java.lang.String, int, java.lang.String)
     */
    public ListeningPoint createListeningPoint(String address, int port,
            String transport) throws TransportNotSupportedException, InvalidArgumentException
    {
      return this.createListeningPoint(address, port, transport, 0, null, true);
    }

    public synchronized ListeningPoint createListeningPoint(String address, int port,
				String transport, int remotePort, String remoteAddr, boolean isServer)
				 throws TransportNotSupportedException, InvalidArgumentException {
			...
			if (lip != null) {
				...
				try {
                    ...
                    if( remoteAddr != null )
                      rAddr = InetAddress.getByName(remoteAddr);
                    ...
                    lip = new ListeningPointImpl(this, port, transport, rAddr, remotePort, isServer);
