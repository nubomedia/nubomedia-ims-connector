...
public class ContactParser extends AddressParametersParser {
	...
	{
		String hdrText = "Contact: sip:p65540t1210162570m714390c3288s1@130.100.144.37:5083;g.3gpp.app_ref=\"urn%3Aurn-xxx%3A3gpp-service.ims.icsi.mmtel\"";
		StringMsgParser smp = new StringMsgParser();
		SIPHeader sipHeader = smp.parseSIPHeader(hdrText);
		System.out.println(sipHeader.getHeaderName()+" ---"+sipHeader.getHeaderValue());
	}
}
